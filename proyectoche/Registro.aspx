<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registro.aspx.cs" Inherits="proyectoche.WebForm2" %>
...
<body>
    ...
    <div class="container position-static fixed-bottom" >
    <form runat="server">
        <div class="form-row">
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <asp:TextBox runat="server" CssClass="form-control" ID="txt_Contrasena" placeholder="Contraseña" TextMode="Password"></asp:TextBox>
  ...
  <div class="form-group">
    <div class="form-check">
      ...
      <asp:Button ID="bt_registrar" runat="server" CssClass="btn btn-primary col-md-12" Text="Registrar" OnClick="bt_registrar_Click" />
</form>
</div>
